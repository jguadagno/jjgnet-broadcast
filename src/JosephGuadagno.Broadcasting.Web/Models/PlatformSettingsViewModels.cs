...
public abstract class PlatformSettingsViewModel : IValidatableObject
{
...
public sealed class BlueskyPlatformSettingsViewModel : PlatformSettingsViewModel
{
...
public sealed class TwitterPlatformSettingsViewModel : PlatformSettingsViewModel
{
...
public sealed class FacebookPlatformSettingsViewModel : PlatformSettingsViewModel
{
...
public sealed class LinkedInPlatformSettingsViewModel : PlatformSettingsViewModel
{
...
public sealed class UnsupportedPlatformSettingsViewModel : PlatformSettingsViewModel
{
    public override string PartialViewName => "_UnsupportedPlatformSettings";
