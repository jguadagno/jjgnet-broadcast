...
/// </summary>
public interface IUserPlatformLinkedInSettingsDataStore
{
    /// <summary>
    ...
    Task<UserPlatformLinkedInSettings?> GetByUserAsync(string ownerOid, CancellationToken cancellationToken = default);
    ...
    /// <param name="cancellationToken">Cancellation token</param>
    /// <returns>The settings if found, otherwise null</returns>
    Task<UserPlatformLinkedInSettings?> GetByIdAsync(int id, CancellationToken cancellationToken = default);
