...
/// </summary>
public interface IUserPublisherTwitterSettingsManager
{
    Task<UserPublisherTwitterSettings?> GetAsync(string ownerOid, CancellationToken cancellationToken = default);
