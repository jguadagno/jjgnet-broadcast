...
/// </summary>
public interface IUserPlatformFacebookSettingsManager
{
    Task<UserPlatformFacebookSettings?> GetAsync(string ownerOid, CancellationToken cancellationToken = default);
