...
/// </summary>
public interface IUserPublisherLinkedInSettingsManager
{
    Task<UserPublisherLinkedInSettings?> GetAsync(string ownerOid, CancellationToken cancellationToken = default);
