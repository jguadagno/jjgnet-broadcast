...
/// </summary>
public interface IUserEventDispatcherMappingDataStore
{
    /// <summary>
    ...
    Task<List<UserEventDispatcherMapping>> GetByUserAsync(string ownerOid, bool activeOnly = false, CancellationToken cancellationToken = default);
    ...
    Task<List<UserEventDispatcherMapping>> GetByUserAndEventTypeAsync(string ownerOid, string eventType, CancellationToken cancellationToken = default);
    ...
    Task<UserEventDispatcherMapping?> GetByIdAsync(int id, CancellationToken cancellationToken = default);
    ...
    Task<UserEventDispatcherMapping?> SaveAsync(UserEventDispatcherMapping mapping, CancellationToken cancellationToken = default);
