...
public class Engagement
{
    ...
    [JsonPropertyName("eventStart")] public DateTimeOffset EventStart { get; set; }
    [JsonPropertyName("eventEnd")] public DateTimeOffset EventEnd { get; set; }
    ...
    [JsonPropertyName("createdOrUpdatedOn")] public DateTimeOffset CreatedOrUpdatedOn { get; set; }
}