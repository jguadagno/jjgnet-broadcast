    ...
    ILogger<RandomPosts> logger)
{
    ...
    [Function(ConfigurationFunctionNames.DispatchersRandomPosts)]
    public async Task RunAsync([TimerTrigger("%dispatchers_random_post_cron_settings%")] TimerInfo myTimer)
    {
        var utcNow = DateTimeOffset.UtcNow;
        logger.LogDebug("{FunctionName} started at: {StartedAt:f}",
            ConfigurationFunctionNames.DispatchersRandomPosts, utcNow);
        ...
        logger.LogDebug("{FunctionName} completed", ConfigurationFunctionNames.DispatchersRandomPosts);
    }
