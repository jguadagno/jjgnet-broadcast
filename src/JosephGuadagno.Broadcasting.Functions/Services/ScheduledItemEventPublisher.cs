...
public class ScheduledItemEventPublisher(
    ...
    ILogger<ScheduledItemEventPublisher> logger) : IScheduledItemEventPublisher
{
    ...
    public async Task PublishAsync(ScheduledItem scheduledItem, CancellationToken cancellationToken = default)
    {
