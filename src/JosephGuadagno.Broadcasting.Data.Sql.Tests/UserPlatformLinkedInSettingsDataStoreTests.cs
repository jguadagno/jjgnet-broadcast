...
/// <summary>
/// Tests for UserPlatformLinkedInSettingsDataStore — isolation and owner enforcement
/// </summary>
public class UserPlatformLinkedInSettingsDataStoreTests : IDisposable
{
    private readonly BroadcastingContext _context;
    private readonly Mock<ILogger<UserPlatformLinkedInSettingsDataStore>> _logger = new();
    private readonly UserPlatformLinkedInSettingsDataStore _dataStore;

    public UserPlatformLinkedInSettingsDataStoreTests()
    {
        ...
        _dataStore = new UserPlatformLinkedInSettingsDataStore(
            _context,
    ...
    private async Task CreateLinkedInSettingsAsync(
        ...
        bool isEnabled = true)
    {
        _context.UserPlatformLinkedInSettings.Add(new UserPlatformLinkedInSettings
        {
    ...
    public async Task GetByIdAsync_ReturnsSettingsById()
    {
        ...
        var entity = await _context.UserPlatformLinkedInSettings.FirstAsync(s => s.CreatedByEntraOid == ownerOid);
    ...
    public async Task SaveAsync_CreatesNewSettings()
    {
        // Arrange
        const string ownerOid = "user-a-oid-11111111";
        var newSettings = new Domain.Models.UserPlatformLinkedInSettings
        {
            CreatedByEntraOid = ownerOid,
            IsEnabled = true,
    ...
    public async Task SaveAsync_UpdatesExistingSettingsForSameOwner()
    {
        ...
        var updatedSettings = new Domain.Models.UserPlatformLinkedInSettings
        {
            CreatedByEntraOid = ownerOid,
            IsEnabled = true,
        ...
        var count = await _context.UserPlatformLinkedInSettings
    ...
    public async Task DeleteAsync_DeletesWhenOwnerMatches()
    {
        ...
        // Assert
        Assert.True(result);
        Assert.Null(await _context.UserPlatformLinkedInSettings.FindAsync(settingsId));
    }
    ...
    public async Task DeleteAsync_ReturnsFalseWhenOwnerMismatch()
    {
        ...
        var entity = await _context.UserPlatformLinkedInSettings.FirstAsync(s => s.CreatedByEntraOid == ownerAOid);
        var settingsId = entity.Id;
        ...
        // Assert
        Assert.False(result);
        var stillExists = await _context.UserPlatformLinkedInSettings.FindAsync(settingsId);
