...
public class SyndicationFeedItemDataStoreTests : IDisposable
{
    private readonly BroadcastingContext _context;
    private readonly SyndicationFeedItemDataStore _dataStore;

    public SyndicationFeedItemDataStoreTests()
    {
        ...
        _dataStore = new SyndicationFeedItemDataStore(_context, mapper, NullLogger<SyndicationFeedItemDataStore>.Instance);
    }
    ...
    private void SeedData()
    {
        ...
        _context.SyndicationFeedItems.AddRange(sources);
    ...
    {
        var newSource = new JosephGuadagno.Broadcasting.Domain.Models.SyndicationFeedItem
        {
        ...
        var dbRecord = await _context.SyndicationFeedItems.FindAsync(result.Value!.Id);
    ...
    public async Task SaveAsync_UpdatesRecord_WhenIdIsNotZero()
    {
        ...
        var dbRecord = await _context.SyndicationFeedItems.FindAsync(1);
    ...
    public async Task SaveAsync_ThrowsApplicationException_WhenSaveReturnsZero()
    {
        ...
        var store = new SyndicationFeedItemDataStore(failingContext, mapper, NullLogger<SyndicationFeedItemDataStore>.Instance);
        var entity = new JosephGuadagno.Broadcasting.Domain.Models.SyndicationFeedItem
        {
            FeedIdentifier = "fail",
            Title = "Should Fail",
            Author = "Author",
