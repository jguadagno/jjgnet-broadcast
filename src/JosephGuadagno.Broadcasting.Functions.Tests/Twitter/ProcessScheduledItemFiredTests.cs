...
public class ProcessScheduledItemFiredTests
{
    ...
    private static Mock<ISocialMediaPlatformManager> BuildPlatformManager()
    {
        ...
        mock.Setup(m => m.GetByNameAsync(MessageTemplates.Platforms.Twitter, It.IsAny<CancellationToken>()))
            .ReturnsAsync(new SocialMediaPlatform { Id = 1, Name = "Twitter", IsActive = true });
        return mock;
    }
