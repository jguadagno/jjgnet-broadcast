...
public class CollectorEventDistributorTests
{
    ...
    private readonly CollectorEventDistributor _sut;

    public CollectorEventDistributorTests()
    {
    ...
    public async Task DispatchSyndicationFeedItemAsync_WhenMappingAndTemplateFound_SendsToCorrectQueue()
    {
        ...
        _mappingDataStore
            .Setup(s => s.GetByUserAndEventTypeAsync(OwnerOid, MessageTemplates.MessageTypes.NewSyndicationFeedItem, It.IsAny<CancellationToken>()))
            .ReturnsAsync(new List<UserEventDistributorMapping> { mapping });
    ...
    public async Task DispatchSyndicationFeedItemAsync_WhenMultipleMappings_SendsToAllConfiguredQueues()
    {
        ...
        var blueskyMapping = new UserEventDistributorMapping
        {
        ...
        _mappingDataStore
            .Setup(s => s.GetByUserAndEventTypeAsync(OwnerOid, MessageTemplates.MessageTypes.NewSyndicationFeedItem, It.IsAny<CancellationToken>()))
            .ReturnsAsync(new List<UserEventDistributorMapping> { twitterMapping, blueskyMapping });
