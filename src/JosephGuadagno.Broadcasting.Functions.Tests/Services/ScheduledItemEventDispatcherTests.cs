...
public class ScheduledItemEventDispatcherTests
{
    ...
    private readonly ScheduledItemEventDispatcher _sut;

    public ScheduledItemEventDispatcherTests()
    {
        ...
        _sut = new ScheduledItemEventDispatcher(
            ...
            NullLogger<ScheduledItemEventDispatcher>.Instance);
    }
    ...
    public async Task DispatchAsync_WhenFeedItemMappingAndTemplateFound_SendsToTwitterQueue()
    {
        ...
        _mappingDataStore
            .Setup(s => s.GetByUserAndEventTypeAsync(OwnerOid, MessageTemplates.MessageTypes.ScheduledItem, It.IsAny<CancellationToken>()))
            .ReturnsAsync(new List<UserEventDispatcherMapping> { ActiveMapping(SocialMediaPlatformIds.Twitter) });
    ...
    public async Task DispatchAsync_WhenYouTubeItemMappingAndTemplateFound_SendsToLinkedInQueue()
    {
        ...
        _mappingDataStore
            .Setup(s => s.GetByUserAndEventTypeAsync(OwnerOid, MessageTemplates.MessageTypes.ScheduledItem, It.IsAny<CancellationToken>()))
            .ReturnsAsync(new List<UserEventDispatcherMapping> { ActiveMapping(SocialMediaPlatformIds.LinkedIn) });
        _youTubeItemManager
            .Setup(m => m.GetAsync(42, It.IsAny<CancellationToken>()))
    ...
    public async Task DispatchAsync_WhenEngagementItemMappingAndTemplateFound_SendsToBlueskyQueue()
    {
        ...
        _mappingDataStore
            .Setup(s => s.GetByUserAndEventTypeAsync(OwnerOid, MessageTemplates.MessageTypes.ScheduledItem, It.IsAny<CancellationToken>()))
            .ReturnsAsync(new List<UserEventDispatcherMapping> { ActiveMapping(SocialMediaPlatformIds.Bluesky) });
        _engagementManager
            .Setup(m => m.GetAsync(42, It.IsAny<CancellationToken>()))
    ...
    public async Task DispatchAsync_WhenTalkItemMappingAndTemplateFound_SendsToFacebookQueue()
    {
        ...
        _mappingDataStore
            .Setup(s => s.GetByUserAndEventTypeAsync(OwnerOid, MessageTemplates.MessageTypes.ScheduledItem, It.IsAny<CancellationToken>()))
            .ReturnsAsync(new List<UserEventDispatcherMapping> { ActiveMapping(SocialMediaPlatformIds.Facebook) });
        _engagementManager
