...
public class ScheduledItemsTests
{
    ...
    private readonly Mock<IScheduledItemEventPublisher> _scheduledItemEventPublisher;
    ...
    public ScheduledItemsTests()
    {
        ...
        _scheduledItemEventPublisher = new Mock<IScheduledItemEventPublisher>();
        ...
        _sut = new ScheduledItems(
            ...
            _scheduledItemEventPublisher.Object,
    ...
    public async Task RunAsync_WhenNoScheduledItemsFound_DoesNotPublishOrMarkSent()
    {
        ...
        _scheduledItemEventPublisher.Verify(m => m.PublishAsync(It.IsAny<ScheduledItem>(), It.IsAny<CancellationToken>()), Times.Never);
    ...
    public async Task RunAsync_WhenScheduledItemsExist_PublishesMarksSentAndUpdatesFeedCheck()
    {
        ...
        _feedCheckManager
            .Setup(m => m.GetByNameAsync(ConfigurationFunctionNames.PublishersScheduledItems, scheduledItem.CreatedByEntraOid!, It.IsAny<CancellationToken>()))
        ...
        _scheduledItemEventPublisher.Verify(m => m.PublishAsync(
        ...
        _feedCheckManager.Verify(m => m.SaveAsync(
            It.Is<FeedCheck>(f => f.Name == ConfigurationFunctionNames.PublishersScheduledItems && f.EntraOId == scheduledItem.CreatedByEntraOid),
            It.IsAny<CancellationToken>()), Times.Once);
    }
    ...
    public async Task RunAsync_WhenOneScheduledItemPublishFails_ContinuesProcessingRemainingItems()
    {
        ...
        _feedCheckManager
            .Setup(m => m.GetByNameAsync(ConfigurationFunctionNames.PublishersScheduledItems, failedItem.CreatedByEntraOid!, It.IsAny<CancellationToken>()))
        ...
        _scheduledItemEventPublisher
            .Setup(m => m.PublishAsync(It.Is<ScheduledItem>(i => i.Id == failedItem.Id), It.IsAny<CancellationToken>()))
