...
public class UserCollectorYouTubeChannelsControllerTests
{
    ...
    public async Task GetAllAsync_ReturnsCurrentUserConfigs_WhenOwnerQueryMissing()
    {
        ...
        _manager
            ...
            .ReturnsAsync(new PagedResult<UserCollectorYouTubeChannel> { Items = [], TotalCount = 0 });
    ...
    public async Task GetAllAsync_ReturnsTargetUserConfigs_WhenSiteAdminTargetsAnotherUser()
    {
        ...
        _manager
            .Setup(m => m.GetAllAsync(It.IsAny<string>(), It.IsAny<int>(), It.IsAny<int>(), It.IsAny<string>(), It.IsAny<bool>(), It.IsAny<string?>(), It.IsAny<CancellationToken>()))
            .ReturnsAsync(new PagedResult<UserCollectorYouTubeChannel> { Items = targetConfigs, TotalCount = targetConfigs.Count });
