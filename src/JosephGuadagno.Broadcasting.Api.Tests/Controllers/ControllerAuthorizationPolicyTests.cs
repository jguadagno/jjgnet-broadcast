...
public class ControllerAuthorizationPolicyTests
{
    public static TheoryData<Type, string> ControllerTypes => new()
    {
        ...
        { typeof(DispatchersController), nameof(DispatchersController) },
        ...
        { typeof(UserEventDispatcherMappingController), nameof(UserEventDispatcherMappingController) },
    ...
    public static TheoryData<Type, string, string> ActionPolicies => new()
    {
        ...
        { typeof(DispatchersController), nameof(DispatchersController.GetAllAsync), AuthorizationPolicyNames.RequireViewer },
        ...
        { typeof(UserEventDispatcherMappingController), nameof(UserEventDispatcherMappingController.GetAllAsync), AuthorizationPolicyNames.RequireViewer },
        { typeof(UserEventDispatcherMappingController), nameof(UserEventDispatcherMappingController.GetAsync), AuthorizationPolicyNames.RequireViewer },
        { typeof(UserEventDispatcherMappingController), nameof(UserEventDispatcherMappingController.CreateAsync), AuthorizationPolicyNames.RequireContributor },
        { typeof(UserEventDispatcherMappingController), nameof(UserEventDispatcherMappingController.UpdateAsync), AuthorizationPolicyNames.RequireContributor },
        { typeof(UserEventDispatcherMappingController), nameof(UserEventDispatcherMappingController.DeleteAsync), AuthorizationPolicyNames.RequireContributor },
