...
public class UserEventDispatcherMappingManagerTests
{
    private readonly Mock<IUserEventDispatcherMappingDataStore> _dataStore = new();
    private readonly UserEventDispatcherMappingManager _sut;

    public UserEventDispatcherMappingManagerTests()
    {
        _sut = new UserEventDispatcherMappingManager(_dataStore.Object);
    }
    ...
    public async Task GetByUserAndEventTypeAsync_DelegatesToDataStore()
    {
        ...
        var expected = new List<UserEventDispatcherMapping>
        {
