...
/// </summary>
public class UserEventDispatcherMappingManager(IUserEventDispatcherMappingDataStore dataStore) : IUserEventDispatcherMappingManager
{
    /// <inheritdoc />
    public Task<List<UserEventDispatcherMapping>> GetByUserAsync(
        string ownerOid,
    ...
    /// <inheritdoc />
    public Task<List<UserEventDispatcherMapping>> GetByUserAndEventTypeAsync(
        string ownerOid,
        string eventType,
        CancellationToken cancellationToken = default)
    {
    ...
    /// <inheritdoc />
    public Task<UserEventDispatcherMapping?> GetByIdAsync(int id, CancellationToken cancellationToken = default)
    {
    ...
    /// <inheritdoc />
    public Task<UserEventDispatcherMapping?> SaveAsync(
