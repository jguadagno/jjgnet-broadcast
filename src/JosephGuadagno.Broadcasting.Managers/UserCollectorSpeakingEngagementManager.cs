...
{
    /// <inheritdoc />
    public Task<List<UserCollectorSpeakingEngagement>> GetByUserAsync(
    ...
    /// <inheritdoc />
    public Task<UserCollectorSpeakingEngagement?> GetByIdAsync(
    ...
    /// <inheritdoc />
    public Task<List<UserCollectorSpeakingEngagement>> GetAllActiveAsync(
    ...
    /// <inheritdoc />
    public Task<UserCollectorSpeakingEngagement?> SaveAsync(
        UserCollectorSpeakingEngagement config, CancellationToken cancellationToken = default)
    {
        ...
        if (!Uri.TryCreate(config.SpeakingEngagementsFile, UriKind.Absolute, out _))
        {
            throw new ArgumentException("SpeakingEngagementsFile must be a valid absolute URI", nameof(config));
        }
    ...
    /// <inheritdoc />
    public Task<PagedResult<UserCollectorSpeakingEngagement>> GetAllAsync(
