...
/// </summary>
public class UserPublisherFacebookSettingsManager(
	...
	: IUserPublisherFacebookSettingsManager
{
	/// <inheritdoc />
    public Task<UserPublisherFacebookSettings?> GetAsync(string ownerOid, CancellationToken cancellationToken = default)
    {
        ArgumentException.ThrowIfNullOrWhiteSpace(ownerOid);
        return userPublisherFacebookSettingsDataStore.GetByUserAsync(ownerOid, cancellationToken);
    }
    ...
    public Task<UserPublisherFacebookSettings?> SaveAsync(UserPublisherFacebookSettings settings, CancellationToken cancellationToken = default)
    {
        ...
        return userPublisherFacebookSettingsDataStore.SaveAsync(settings, cancellationToken);
    }
    ...
    {
        ArgumentException.ThrowIfNullOrWhiteSpace(ownerOid);
        var existing = await userPublisherFacebookSettingsDataStore.GetByUserAsync(ownerOid, cancellationToken);
        if (existing is null)
        {
            return false;
        }
        return await userPublisherFacebookSettingsDataStore.DeleteAsync(existing.Id, ownerOid, cancellationToken);
    }
