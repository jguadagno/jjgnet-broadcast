...
> Learnings from 2026-05-19 to 2026-05-26 archived to history-archive.md (2026-05-29)

## Process-Flow Documentation Mermaid Migration — 2026-05-29

**Task**: Replaced 4 outdated draw.io SVG files with 9 Mermaid Markdown documents in `docs/process-flows/`.

**Outcome**: All process flow diagrams now maintained as Markdown with embedded Mermaid syntax. Collectors, dispatchers, and publisher routing paths documented with current architecture. SVG files deleted.
...
**Outcome**: All controllers now emit tag metadata for Scalar API docs. Build and tests passed.
...
- Root cause: AbsoluteExpirationRelativeToNow override in MsalDistributedTokenCacheAdapterOptions
...
**Note:** This file will be auto-archived when exceeding 15360 bytes. Pre-2026-05-19 learnings in history-archive.md.
