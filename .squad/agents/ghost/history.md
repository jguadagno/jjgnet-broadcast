...
- **Recent:** MSAL auth exceptions, session cache management, scope verification
- **Critical:** HttpOnly/Secure/SameSite cookie flags, dual-scope acceptance for backward compat
- **Key pattern:** RejectSessionCookieWhenAccountNotInCacheEvents, MsalExceptionMiddleware
- **Focus:** Auth pipeline resilience, cache collision handling, RBAC middleware
