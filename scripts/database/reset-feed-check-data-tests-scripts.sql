...
-- Reset New Posts
DELETE FROM SyndicationFeedItems WHERE Url = 'http://localhost:4000/2026/02/16/jetbrains-rider-settings-for-presentations'
...
SELECT * FROM SyndicationFeedItems WHERE Url like '%http://localhost:4000/%'
...
DELETE FROM YouTubeItems WHERE VideoId = 'N1p6WDFIVFRUVTQ='
...
SELECT * FROM YouTubeItems WHERE VideoId = 'N1p6WDFIVFRUVTQ='
